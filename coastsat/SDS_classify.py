...
def evaluate_classifier(classifier, metadata, settings):
    ...
    Returns:
    -----------
    Saves .jpg images with the output of the classification in the folder ./evaluation
    ...
    for satname in metadata.keys():
        ...
        # load classifiers and set pixel size
        ...
        for i in range(len(filenames)):
            ...
            try:
                ...
                im_ref_buffer = SDS_shoreline.create_shoreline_buffer(cloud_mask.shape, georef, image_epsg, pixel_size, settings)
                # classify image in 4 classes (sand, whitewater, water, other) with NN classifier
                im_classif, im_labels = SDS_shoreline.classify_image_NN(im_ms, cloud_mask, min_beach_area_pixels, classifier)
                ...
                sl_pix = SDS_tools.convert_world2pix(SDS_tools.convert_epsg(shoreline, settings['output_epsg'], image_epsg), georef)
